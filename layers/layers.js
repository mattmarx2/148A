...
var format_148A_4 = new ol.format.GeoJSON();
var features_148A_4 = format_148A_4.readFeatures(json_148A_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3763'});
var jsonSource_148A_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_148A_4.addFeatures(features_148A_4);
var lyr_148A_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_148A_4, 
                style: style_148A_4,
                popuplayertitle: '148A',
                interactive: true,
                title: '<img src="styles/legend/148A_4.png" /> 148A'
            });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_xref_tracado_1.setVisible(true);lyr_LimitesAdmin_2.setVisible(true);lyr_LimiteExprop_3.setVisible(true);lyr_148A_4.setVisible(true);
